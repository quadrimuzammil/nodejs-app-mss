...
withDockerRegistry(credentialsId: 'gcr:git-jbash-123', url: 'https://gcr.io/git-jbash-123') {
    sh 'docker push gcr.io/git-jbash-123/nodejsappmss:${BUILD_NUMBER}'
            ...
            steps{
                ...
                step([$class: 'KubernetesEngineBuilder', projectId: env.PROJECT_ID, clusterName: env.CLUSTER_NAME, location: env.LOCATION, manifestPattern: 'nodejsdeployment.yaml', credentialsId: env.CREDENTIALS_ID])
            }
        }
